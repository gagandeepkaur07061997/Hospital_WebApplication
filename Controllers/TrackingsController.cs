...
namespace Hospital_WebApplication.Controllers
{
    public class TrackingsController : Controller
    {
        ...
        public TrackingsController(Hospital_WebApplicationDatabase context)
        {
            _context = context;
        }
        ...
        {
            var hospital_WebApplicationDatabase = _context.Tracking.Include(t => t.Parcel);
            return View(await hospital_WebApplicationDatabase.ToListAsync());
        }
