...
namespace Hospital_WebApplication.Controllers
{
    public class ParcelsController : Controller
    {
        ...
        public ParcelsController(Hospital_WebApplicationDatabase context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Delivery_address,Parcel_weight,Content_type,Shipping_cost,SenderId,CompanyId,RecieverId")] Parcel parcel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Delivery_address,Parcel_weight,Content_type,Shipping_cost,SenderId,CompanyId,RecieverId")] Parcel parcel)
        {
            if (id != parcel.Id)
            {
                return NotFound();
